...
class _CreatePostPageState extends State<CreatePostPage> {
  ...
  void _sendPost() async {
    ...
    final success = await postsProvider.submitPost(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
                ...
                builder: (context, postsProvider, child) { 
                  return SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: postsProvider.isSubmitting ? null : _sendPost,
                      ...
                      child: postsProvider.isSubmitting
                          ? const Row(
              ...
              Consumer<PostsProvider>(
                builder: (context, postsProvider, child){
                  if (postsProvider.responseMessage.isNotEmpty) return SizedBox.shrink();
                
                return Container(
                  padding: const EdgeInsets.all(16),
                  decoration: BoxDecoration(
                    color: postsProvider.responseMessage.toLowerCase().contains("success")
                        ? Colors.green[50]
                        : Colors.blue[50],
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
                  ...
                  child: Row(
                    children: [
                      Icon(
                        postsProvider.responseMessage.toLowerCase().contains("success")
                            ? Icons.check_circle
                            : Icons.info,
                        color: postsProvider.responseMessage.toLowerCase().contains("success")
                            ? Colors.green[600]
